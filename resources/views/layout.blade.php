...
<div id="left_side" class="left_side">
    <div class="logos">
        ...
        <div onclick="location.href='#'" style="cursor: pointer;" class="h15" role="tooltip" aria-hidden="false" aria-describedby="1" aria-labelledby="1">
        ...
        <div onclick="location.href='#'" style="cursor: pointer;" class="h15" role="tooltip" aria-hidden="false" aria-describedby="5" aria-labelledby="5">
...
<div id="right_side" class="right_side">
    {{--   30% --}}
    <div>
        <a href="#" type="text" id="premium-box" class="premium-box">Get Premium plan</a>
    </div>
    <div>
