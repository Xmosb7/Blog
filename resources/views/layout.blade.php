...
<body>
    ...
    <div id="left_side" class="left_side">
        <div class="logos">
            ...
            <div onclick="location.href='{{ url('/') }}'" style="cursor: pointer;" class="h15"
            ...
            <div onclick="location.href='{{ route('post.write') }}" style="cursor: pointer;" class="h15"
                role="tooltip" aria-hidden="false" aria-describedby="5" aria-labelledby="5">
